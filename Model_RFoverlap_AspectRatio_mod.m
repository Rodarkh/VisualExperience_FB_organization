function Model_RFoverlap_AspectRatio_mod(dRF_LM, dRF_V1,dentriticSize, LM_Group1_RFs, LM_Group2_RFs, V1_RFs, connectivityRule, borderOfEllipseFromSD, survivalGain, numberOfSamples, ecc_factor, iterationCycleID, motherSaveFolder)
%% HELP:
...
saveFigFolder = [motherSaveFolder, filesep, 'Model', filesep, currSettings, '_AspectRatio'];
