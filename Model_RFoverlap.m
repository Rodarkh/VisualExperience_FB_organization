function Model_RFoverlap(dRF_LM, dRF_V1,dentriticSize, LM_Group1_RFs, LM_Group2_RFs, V1_RFs, connectivityRule,borderOfEllipseFromSD,survivalGain,numberOfSamples,iterationCycleID)
%% HELP:
...
saveFigFolder = [ 'Model', filesep, currSettings, filesep, LM_Group1_RFs(1:(end-5))];
titleText = [currSettings, '; ',num2str(numberOfSamples/1000),'k samples'];

saveAnalFolder = [ 'Model', filesep, currSettings, filesep, LM_Group1_RFs(1:(end-5)), filesep, 'analysis'];
