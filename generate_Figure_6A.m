function generate_Figure_6A(initial_LM_dRF, initial_V1_dRF, dendriticSize, V1_RFshape, connectivityRule, borderOfEllipseFromSD, survivalGain, nSamples,ec, nIter) 
...
dataFolder=[ 'Model', filesep, currSettings, '_AspectRatio'];  
cd(dataFolder);
