function generate_Figure_5(initial_LM_dRF, initial_V1_dRF, dendriticSize, V1_RFshape, connectivityRule, borderOfEllipseFromSD, survivalGain, nSamples, n_iter,motherSaveFolder) 
...
for iii=1:nGroups
    ...
    pathLoad = [motherSaveFolder, filesep, 'Model', filesep, currSettings, filesep, groups{iii}, filesep, 'analysis'];
